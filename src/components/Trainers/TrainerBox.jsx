...
function TrainerBox() {
  ...
  const trainers = [
    { img: Trainer1, name: "Gennady Golovkin", job: "Boxing Trainer" },
    { img: Trainer2, name: "Muhammed Ali", job: "Crossfit Trainer" },
    { img: Trainer3, name: "Mike Tyson", job: "Personal Trainer" },
  ];
